...
class AddPropertyState extends Equatable {
  ...
  const AddPropertyState({this.isClear=false,this.image=const<String>[],this.errorMessage = '', this.status = Current.init});

  AddPropertyState copyWith(
      {String? errorMessage, Current? status, List<String>? image,bool? isClear}) {
